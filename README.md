...
- **Govt & PSU tab** — 60 Indian government, PSU (Maharatna/Navratna/Miniratna), public sector bank/insurer and govt-backed tech orgs (NPCI, ONDC, RBIH, DIC, UIDAI...) with verified careers links, a per-org site search, category filters, and "last checked" tracking that flags anything not checked in 7 days. Plus govt job boards and Google searches for the titles govt uses instead of "Product Manager" (Consultant, Specialist Officer, Lead - Product).
